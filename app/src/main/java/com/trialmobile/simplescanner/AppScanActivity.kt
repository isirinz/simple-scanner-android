package com.trialmobile.simplescanner
...
import com.trialmobile.simplescanner.adapters.ImageAdapter
import com.trialmobile.simplescanner.adapters.ImageAdapterListener
...
class AppScanActivity: ScanActivity(), ImageAdapterListener {
    ...
    private fun saveImage(image: File) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            contentValues.put(MediaStore.MediaColumns.DISPLAY_NAME, "simple-scanner-${dateFormatted}.jpg")
            ...
            val to = File(Environment.getExternalStorageDirectory().absolutePath + "/" + Environment.DIRECTORY_DCIM + "/simple-scanner-${dateFormatted}.jpg")
